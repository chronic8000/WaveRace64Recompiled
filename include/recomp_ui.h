...
namespace recompui {
    ...
    void queue_auto_start_game();
    void try_run_queued_auto_start(uint32_t host_frame_index);
    ...
    void close_prompt();
    bool is_prompt_open();
    void reset_game_loading_overlay();
    void notify_game_gfx_submitted();
    bool is_game_gfx_submitted();
    bool is_nonempty_game_frame_presented();
    void dismiss_game_loading_overlay();
    bool is_game_loading_dismissed();
    ...
    void set_sdl_window_thread_id(uint32_t thread_id);
